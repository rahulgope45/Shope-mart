...
// Initialize thumbnail with null
...
// Set thumbnail when product images are available
useEffect(() => {
  ...
  return product && (
    <div className="mt-12">
            ...
            <div className='flex flex-col items-center mt-20'>
                ...
                <p
                className='text-3x1 font-medium'
                >Related Products</p>
                <div className='w-16 h-0.5 bg-primary roundd-full'></div>
            </div>
            <div className=' grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-5 md:gap-6 lg:grid-cols-5 mt-6 w-full'>
